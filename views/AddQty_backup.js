...
import {getCartItemDetails, imagePrefix, SaveOrder} from '../api/apiService';
    ...
    AsyncStorage.getItem('selectedLoadedItemsByQty').then(data => {
      ...
      getCartItemDetails(data).then(res => {
        ...
        for (var i = 0; i < myNewDataFromApi.length; i++) {
          valuetem[
            Object.keys(myNewDataFromApi[i]) +
              '_' +
              Object.values(myNewDataFromApi[i])[0].id
          ] = Object.values(myNewDataFromApi[i])[0].order_qty;
                        ...
                        <View style={styles.mainBox} key={generateRandString()}>
                          ...
                          <View
                            ...
                            <TextInput
                              ...
                              value={
                                valueData[
                                  currentSelectedLoadName + '_' + val.id
                                ]
                              }
                              ...
                              onChange={value => {
                                ...
                                for (
                                  var i = 0;
                                  i < Object.keys(valueData).length;
                                  i++
                                ) {
                                  if (
                                    Object.keys(valueData)[i] ==
                                    currentSelectedLoadName + '_' + val.id
                                  ) {
                                    myNewData[
                                      currentSelectedLoadName + '_' + val.id
                                    ...
                                    myNewData[Object.keys(valueData)[i]] =
                                      Object.values(valueData)[i];
                                  }

...
export default function Todayinvoices({navigation}) {
  ...
  function printReceipt(data) {
    ...
    getSaleItemByInv(invoiceNo).then(
      res => {
        if (device != undefined) {
          BluetoothManager.connect(device).then(
            () => {
              printDesign(
                Object.values(res),
                invoiceNo,
  ...
  async function printDesign(
    ...
    await BluetoothEscposPrinter.printText('Items without VAT', {
      encoding: 'GBK',
      codepage: 0,
      widthtimes: 0,
      heigthtimes: 0,
    ...
    await BluetoothEscposPrinter.printText('Items with VAT', {
      encoding: 'GBK',
      codepage: 0,
      widthtimes: 0,
      heigthtimes: 0,
  ...
  function changeStatus() {
    ...
    updatePaymentStatus(invoice, status).then(
      res => {
        getlist();
      },
      err => {
                      ...
                      <ListItem bottomDivider key={i}>
                        ...
                        <View>
                          <Pressable
                            ...
                            onPress={() => {
                              ViewPrintableReciept(l[0].invoice_no);
                            }}>
                        ...
                        <View style={{flexDirection: 'column'}}>
                          ...
                          {selectedPerson == l[0].invoice_no ? (
                            <View
                              ...
                              <Pressable
                                onPress={() => {
                                  showModels(l[0].invoice_no, 'cash');
                                }}>
                              ...
                              <Pressable
                                onPress={() => {
                                  showModels(l[0].invoice_no, 'bank_transfer');
                                }}>
                        ...
                        <View style={{flexDirection: 'row'}}>
                          ...
                          <View
                            ...
                            <Pressable
                              ...
                              onPress={() => {
                                gotoCart(l[0].invoice_no, l[0].buyer_rel.id);
                              }}>
                              <Text

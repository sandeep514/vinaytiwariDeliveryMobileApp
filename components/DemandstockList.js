      ...
      <View style={{width: '20%', alignItems: 'center', flexDirection: 'row'}}>
        ...
        <View style={{width: 100}}>
          <Input
            ...
            defaultValue={
              data.id in updateSt ? updateSt[data.id].toString() : '0'
            }
            disabled
          />
        </View>
        <View>
          <Pressable
            style={{backgroundColor: Colors.primary, padding: 8, height: 30}}
            onPress={() => {
              incrementedProduct(data);
            }}>
            <Icon
              name="plus"
              type="font-awesome"

...
export const getItemsByVehicleAndLoads = (vehicheId, load_numbers) => {
  return apiClient.post('get-load-items-by-vehicle-load', {
...
export const getListInvoices = (vehicheNumber, driverId) => {
  return new Promise((resolve, reject) => {
    apiClient
      .get('get-sales-details/' + vehicheNumber + '/' + driverId)
      .then(response => {
        if (response.data.status == true) {
          resolve(response);
        } else {
...
export const getCartItemDetails = postedData => {
  return apiClient.post('get-cart-item-details', {
...
export const getSaleItemByInvoice = invoiceNo => {
  return new Promise((resolve, reject) => {
    apiClient
      .post('get-sale-item-by-invoice', {invoiceNumber: invoiceNo})
      .then(response => {
        if (response.data.status == true) {
          resolve(response);
        } else {
...
export const searchBuyerByInvoiceNumber = invoiceNo => {
  return new Promise((resolve, reject) => {
    apiClient
      .post('find-sale-item-like-invoice', {invoiceNumber: invoiceNo})
      .then(response => {
        if (response.data.status == true) {
          resolve(response);
        } else {
